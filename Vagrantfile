...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define "agent1" do |client|
    client.vm.host_name = "agent1.puppetlabs.vm"
    client.vm.box = "puppetlabs/centos-7.0-64-nocm"
    client.vm.network "private_network", ip: "172.16.5.21"
    client.vm.provision :hosts
  end

  config.vm.define "agent2" do |client|
    client.vm.host_name = "centos7-agent3.puppetlabs.vm"
    client.vm.box = "puppetlabs/centos-7.0-64-nocm"
    client.vm.network "private_network", ip: "172.16.5.22"
    client.vm.provision :hosts
  end
